...
global countMinesP2, showNumMinesP2, posCursorP2, showMarkP2, moveCursorP2, markMineP2, searchMinesP2, checkEndP2, playP2
...
markMineP2:
   ...
   ; rdi = &marks[row][col]
   mov  eax, esi
   imul eax, eax, DIMMATRIX     ; *9
   add  eax, edx                ; +col
   add  rdi, rax                ; rdi apunta a marks[row][col]
...
searchMinesP2:
   ...
   ; explota si hi ha mina
   cmp bl, '*'            ; MODIFICAT
   je sm_boom             ; MODIFICAT
